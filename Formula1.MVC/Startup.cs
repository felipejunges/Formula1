        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                endpoints.MapAreaControllerRoute(
                    areaName: "Admin",
                    name: "Resultado",
                    pattern: "{temporada:int=2023}/Admin/{controller}/{corridaId:int}/{action=Index}/{id?}");

                endpoints.MapAreaControllerRoute(
                    areaName: "Admin",
                    name: "Admin",
                    pattern: "{temporada:int=2023}/Admin/{controller=Home}/{action=Index}/{id?}");

                endpoints.MapControllerRoute(
                    name: "default",
                    pattern: "{temporada:int=2023}/{controller=Home}/{action=Index}/{id?}");
            });
