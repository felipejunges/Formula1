...
namespace Formula1.Domain.Services
{
    public class CorridasService
    {
        ...
        public List<PilotoResultadosPosicaoModel> GetPilotosResultadosPorPosicoes(int temporada)
        {
        ...
        public List<PilotoResultadosPontosModel> GetPilotosResultadosPorPontos(int temporada)
        {
            var resultados = Db.Resultados
                .Include(o => o.Piloto)
                .Include(o => o.Corrida)
        ...
        public List<EquipeResultadosPontosModel> GetEquipesResultadosPorPontos(int temporada)
        {
            var resultados = Db.Resultados
                .Include(o => o.Equipe)
                .Include(o => o.Corrida)
