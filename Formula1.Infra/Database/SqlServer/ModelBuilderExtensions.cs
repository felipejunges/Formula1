    ...
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Resultado>().HasData(
                    ...
                    new ResultadoInclusao(147, CORRIDA1005, DANIEL_RICCARDO, RENAULT, posicaoLargada: 8, posicaoChegada: 7, pontos: 6),
                    new ResultadoInclusao(148, CORRIDA1005, KIMI_RAIKKONEN, ALFA_ROMEO, posicaoLargada: 12, posicaoChegada: 8, pontos: 4),
                    new ResultadoInclusao(149, CORRIDA1005, NICO_HULKENBERG, RENAULT, posicaoLargada: 13, posicaoChegada: 9, pontos: 2),
                    new ResultadoInclusao(150, CORRIDA1005, LANDO_NORRIS, MCLAREN, posicaoLargada: 5, posicaoChegada: 10, pontos: 1),
                    new ResultadoInclusao(151, CORRIDA1005, PIERRE_GASLY, REDBULL, posicaoLargada: 9, posicaoChegada: 11, pontos: 0),
            ...
            modelBuilder.Entity<Resultado>().HasData(
                    ...
                    new ResultadoInclusao(172, CORRIDA1006, NICO_HULKENBERG, RENAULT, posicaoLargada: 15, posicaoChegada: 12, pontos: 0),
                    new ResultadoInclusao(173, CORRIDA1006, DANIEL_RICCARDO, RENAULT, posicaoLargada: 12, posicaoChegada: 13, pontos: 0),
